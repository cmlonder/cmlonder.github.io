...
<figure class="chart" data-chart="appalchemy-ciro">
  <svg class="chart-svg" viewBox="0 0 640 240" role="img" aria-label="AppAlchemy aylık ciro: 17K (2025-08) → 6.4K (2026-09), %62 düşüş" preserveAspectRatio="xMidYMid meet">
    <line class="base" x1="58" y1="206" x2="622" y2="206" />
    <polyline class="line" points="58.0,34.0 622.0,140.8" />
    <circle class="dot" cx="58.0" cy="34.0" r="4.5" />
    <text class="val" x="58.0" y="20.0" text-anchor="start">17K</text>
    <text class="lbl" x="58.0" y="230" text-anchor="start">2025-08</text>
    <circle class="dot" cx="622.0" cy="140.8" r="4.5" />
    <text class="val" x="622.0" y="126.8" text-anchor="end">6.4K</text>
    <text class="lbl" x="622.0" y="230" text-anchor="end">2026-09</text>
  </svg>
  <figcaption>AppAlchemy aylık ciro</figcaption>
</figure>
