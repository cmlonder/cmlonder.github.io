...
export const USES: Grup[] = [
  {
    ...
    items: [
      { name: 'Apple silicon Mac', icon: 'siApple', url: 'https://www.apple.com/mac/', why: { en: 'macOS 26. I stopped caring about this layer.', tr: 'macOS 26. Bu katmanı umursamayı bıraktım.' } },
      { name: 'zsh', icon: 'siZsh', url: 'https://www.zsh.org', why: { en: 'The shell. Nothing exotic on top.', tr: 'Kabuk. Üstünde egzotik bir şey yok.' } },
    ],
  },
  {
    ...
    items: [
      ...
      { name: 'Cursor', icon: 'siCursor', url: 'https://cursor.com', why: { en: 'Open for reading and the occasional hand edit.', tr: 'Okumak ve ara sıra elle düzeltmek için açık.' } },
      { name: 'VS Code', url: 'https://code.visualstudio.com', why: { en: 'Same role as Cursor; the work no longer lives here.', tr: 'Cursor ile aynı rol; iş artık burada geçmiyor.' } },
    ],
  },
  {
    id: 'terminal', label: { en: 'Terminal', tr: 'Terminal' },
    items: [
      { name: 'iTerm', icon: 'siIterm2', url: 'https://iterm2.com', why: { en: 'The window everything else runs in.', tr: 'Her şeyin içinde koştuğu pencere.' } },
